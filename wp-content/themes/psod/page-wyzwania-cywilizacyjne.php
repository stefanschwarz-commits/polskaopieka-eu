...
<section id="cele" style="margin-bottom: 2.25rem;">
    ...
    <h2 class="section-heading section-heading--page text-center">Wyzwania cywilizacyjne</h2>
        ...
        <a class="btn btn-arrow mx-auto w-auto mt-3 p-0 <?php if($counter % 2 == 0) {echo 'ms-lg-5';} ?>" href="<?php echo esc_url( $link ); ?>">Czytaj więcej <img class="ms-1" src="<?= get_template_directory_uri(); ?>/assets/arrow-right.svg" alt=""></a>
        </div>
        </div>   
